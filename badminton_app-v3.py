...
# ---------------------------------------------------------
with tab_stats:
    st.markdown("### 🏆 BẢNG VINH DANH & BẢNG TIỀM LONG (Chỉ tính các buổi Đã hoàn thành)")
    ...
    with col_lead1:
        st.markdown("#### 🥇 BẢNG VINH DANH (Top 20 Chăm Chỉ)")
        if not play_counts:
    ...
    with col_lead2:
        st.markdown("#### 🐉 BẢNG TIỀM LONG (Top 20 Đóng Góp)")
        if not spending_map:
